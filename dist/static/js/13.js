...
// load the styles
var content = __webpack_require__("8sSp");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("60d0d08a", content, true);
        ...
        if (valid) {
          ...
          _this7.request({
            ...
            if (data.status == 1) {
              ...
              _this7.formData = {};
              _this7.addPageShow = false;
              _this7.listPageShow = true;
              _this7.getDataList();
            } else {
              _this7.$message({
                showClose: true,
