...
// load the styles
var content = __webpack_require__("w/O9");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("0cad471e", content, true);
...
/* harmony default export */ var monitor = (defineProperty_default()({
  ...
  methods: {
    getProjectProcessMap: function getProjectProcessMap() {
      ...
      this.request({
        ...
        if (data.status == 1) {
          ...
          //施工进度
          _this.progressCheckList = data.data.project;
          _this.initCanvas();
          //  this.getLineType();
        }
      });
    ...
    // 施工进度
    progressCheckSelect: function progressCheckSelect() {
      this.getProjectProcessMap();
    },
