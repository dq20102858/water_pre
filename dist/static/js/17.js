  ...
  methods: {
    ...
    addOrEditDialog: function addOrEditDialog() {
      ...
      this.$refs["carDetectorForm"].validate(function (valid) {
        if (valid) {
          var data = _this4.carDetectorData;
          _this4.request({
            ...
            if (data.status == 1) {
              ...
              _this4.carDetectorData.name = "";
              _this4.carDetectorData.description = "";
              _this4.getDataList();
              _this4.$message({
                type: "success",
                message: "保存成功！"
    ...
    goEdit: function goEdit(id) {
      ...
      this.request({
        ...
        var data = response.data;
        if (data.status == 1) {
          _this5.carDetectorData = data.data;
        }
      });
    },
...
// load the styles
var content = __webpack_require__("jT9Q");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("65945633", content, true);
