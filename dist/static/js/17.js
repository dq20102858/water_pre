...
// load the styles
var content = __webpack_require__("+RNG");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("039f9b62", content, true);
        ...
        if (valid) {
          ...
          _this3.request({
            ...
            if (data.status == 1) {
              ...
              _this3.detectorData.name = "";
              _this3.detectorData.description = "";
              _this3.getDataList();
              _this3.$message({
                type: "success",
                message: "保存成功！"
