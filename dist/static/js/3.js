...
// load the styles
var content = __webpack_require__("QhsD");
...
// load the styles
var content = __webpack_require__("4/gT");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("25afa2d0", content, true);
  ...
  data: function data() {
    return {
      ...
      rules: {
        ...
        location: [{ required: true, message: "请输入令处所", trigger: "blur" }, { min: 2, max: 30, message: "请输入长度在2到30个字符", trigger: "blur" }],
        driver_id: [{ required: true, message: "请选择受令机车", trigger: "change" }],
        station: [{ min: 2, max: 30, message: "请输入长度在2到30个字符", trigger: "blur" }],
        dispatch_id: [{ required: true, message: "请选择调度员", trigger: "change" }]
      },
      temprules: {
        name: [{ required: true, message: "请输入名称", trigger: "blur" }, { min: 2, max: 30, message: "请输入长度在2到30个字符", trigger: "blur" }],
        description: [{ required: true, message: "请输入内容", trigger: "blur" }, { min: 2, max: 500, message: "请输入长度在2到500个字符", trigger: "blur" }]
      }
    };
  },
  created: function created() {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-02e46c50","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/dispatch/edit.vue
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-48c7e5ab","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/dispatch/detail.vue
var detail_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app-page-layer",attrs:{"id":"dispatch-detail"}},[_c('div',{staticClass:"app-dialog-form"},[_c('el-form',{attrs:{"inline":true}},[_c('el-form-item',{attrs:{"label":"命令号："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.number),callback:function ($$v) {_vm.$set(_vm.dataInfo, "number", $$v)},expression:"dataInfo.number"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"值班调度："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.dispatch),callback:function ($$v) {_vm.$set(_vm.dataInfo, "dispatch", $$v)},expression:"dataInfo.dispatch"}})],1),_vm._v(" "),_c('el-form-item',{staticClass:"redinput",attrs:{"label":"命令状态："}},[(_vm.dataInfo.status=='1')?_c('p',[_c('el-input',{attrs:{"readonly":"","value":"新命令"}})],1):_vm._e(),_vm._v(" "),(_vm.dataInfo.status=='2')?_c('p',[_c('el-input',{attrs:{"readonly":"","value":"已确认"}})],1):_vm._e(),_vm._v(" "),(_vm.dataInfo.status=='3')?_c('p',[_c('el-input',{attrs:{"readonly":"","value":"已作废"}})],1):_vm._e()]),_vm._v(" "),_c('el-form-item',{attrs:{"label":"受令机车："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.loco),callback:function ($$v) {_vm.$set(_vm.dataInfo, "loco", $$v)},expression:"dataInfo.loco"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"受令司机："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.driver),callback:function ($$v) {_vm.$set(_vm.dataInfo, "driver", $$v)},expression:"dataInfo.driver"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"受令车长："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.master),callback:function ($$v) {_vm.$set(_vm.dataInfo, "master", $$v)},expression:"dataInfo.master"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"发令时间："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.create_time),callback:function ($$v) {_vm.$set(_vm.dataInfo, "create_time", $$v)},expression:"dataInfo.create_time"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"受令车站："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.station==''?'无' : _vm.dataInfo.station),callback:function ($$v) {_vm.$set(_vm.dataInfo.station==''?'无' : _vm.dataInfo, "station", $$v)},expression:"dataInfo.station==''?'无' : dataInfo.station"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"车站值班员："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.station_worker==''?'无' : _vm.dataInfo.station_worker),callback:function ($$v) {_vm.$set(_vm.dataInfo.station_worker==''?'无' : _vm.dataInfo, "station_worker", $$v)},expression:"dataInfo.station_worker==''?'无' : dataInfo.station_worker"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"确认时间："}},[(_vm.dataInfo.makesure_time=='')?_c('p',[_c('el-input',{attrs:{"readonly":"","value":"暂未确认"}})],1):_c('p',[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.makesure_time),callback:function ($$v) {_vm.$set(_vm.dataInfo, "makesure_time", $$v)},expression:"dataInfo.makesure_time"}})],1)]),_vm._v(" "),_c('el-form-item',{attrs:{"label":"受令处所："}},[_c('el-input',{attrs:{"readonly":""},model:{value:(_vm.dataInfo.location),callback:function ($$v) {_vm.$set(_vm.dataInfo, "location", $$v)},expression:"dataInfo.location"}})],1),_vm._v(" "),_c('el-form-item'),_vm._v(" "),_c('el-form-item',{staticClass:"contents",attrs:{"label":"调度命令内容："}},[_c('el-input',{attrs:{"type":"textarea"},model:{value:(_vm.dataInfo.description),callback:function ($$v) {_vm.$set(_vm.dataInfo, "description", $$v)},expression:"dataInfo.description"}})],1)],1),_vm._v(" "),_c('div',{staticClass:"app-dialog-footer",attrs:{"slot":"footer"},slot:"footer"},[_c('el-button',{on:{"click":_vm.isCancel}},[_vm._v("关闭")])],1)],1)])}
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-1a23e50e","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/dispatch/printing.vue
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-3213b2a6","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/dispatch/index.vue
...
// load the styles
var content = __webpack_require__("J172");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("74740cad", content, true);
...
// load the styles
var content = __webpack_require__("EuV5");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("27489bbe", content, true);
