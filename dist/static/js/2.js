...
// load the styles
var content = __webpack_require__("MVoN");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("79803567", content, true);
      ...
      this.$refs["companyRulesForm"].validate(function (valid) {
        if (valid) {
          ...
          _this2.request({
            ...
            var data = response.data;
            if (data.status == 1) {
              _this2.companyDialogVisible = false;
              _this2.$message({
                type: "success",
                message: "保存成功！"
              });
