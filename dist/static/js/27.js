        ...
        if (data.status == 1) {
          ...
          _this4.lineTypeList.map(function (item, index) {
            if (item.id == data.data.line_type) {
              ...
              _this4.formData.speed = parseFloat(data.data.speed);
            }
          });
        }
      });
...
// load the styles
var content = __webpack_require__("pN+j");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("6ed3aa20", content, true);
