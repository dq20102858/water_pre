...
// load the styles
var content = __webpack_require__("kFm5");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("1b23c4ed", content, true);
...
/* harmony default export */ var security = ({
  ...
  methods: {
    ...
    getDataList: function getDataList() {
      ...
      var start_time = null;
      var end_time = null;
      var array_time = this.searchForm.time_range;
    ...
    getDangerType: function getDangerType() {
      ...
      this.request({
        ...
        var data = res.data;
        if (data.status == 1) {
          _this5.dangerTypeList = data.data.data.reverse();
        }
      });
    },
    ...
    getDangerDetermine: function getDangerDetermine() {
      ...
      this.request({
        ...
        var data = res.data;
        if (data.status == 1) {
          _this6.dangerDetermineList = data.data.data.reverse();
        }
      });
    },
    ...
    uploadChange: function uploadChange(file, fileList) {
      ...
      if (regex.test(fileName.toLowerCase())) {
        ...
        this.$message.error("请选择图片格式文件.jpg | .jpeg | .gif | .png | .bmp");
    ...
    addEvent: function addEvent() {
      ...
      this.$refs["formRulesRef"].validate(function (valid) {
        if (valid) {
          var data = _this7.formData;
          var img_urls = [];
          var uls = document.getElementsByClassName("el-upload-list");
          for (var i = 0; i < uls.length; i++) {
            var imgs = uls[i].getElementsByClassName("imgfileitem");
    ...
    goDetail: function goDetail(id) {
      ...
      this.request({
        ...
        var data = res.data;
        if (data.status == 1) {
          _this8.eventTitle = " 发起新事件：";
          _this8.eventDesc = data.data.description;
          _this8.eventPictureList = data.data.file;
        }
      });
      this.request({
        ...
        var data = res.data;
        if (data.status == 1) {
          _this8.eventPeopleList = data.data;
        }
      });
    },
    ...
    setDetermineDialog: function setDetermineDialog() {
      ...
      this.request({
        ...
        if (data.status == 1) {
          ...
          _this9.diaDangerFormVisible = false;
          _this9.addPageShow = false;
          _this9.listPageShow = true;
          _this9.getDataList();
        } else {
          _this9.$message.error("设置失败，请稍后再试");
        }
      });
    },
    ...
    uploadThreeChange: function uploadThreeChange(file, fileList) {
      var fileName = file.name;
      var regex = /(.jpg|.jpeg|.gif|.png|.bmp)$/;
      if (regex.test(fileName.toLowerCase())) {
        //this.form.silder_image = file.url;
    ...
    uploadThreeRequest: function uploadThreeRequest(file) {
      var upload_list_li = document.getElementsByClassName("el-upload-list")[0].children;
      var that = this;
      var formData = new FormData();
      formData.append("file", file.file);
    ...
    getAssigners: function getAssigners() {
      ...
      this.request({
        ...
        var data = res.data;
        if (data.status == 1) {
          _this10.assignersList = data.data;
        }
      });
    },
    ...
    saveAssignDialog: function saveAssignDialog() {
      ...
      this.$refs["peopleRulesRef"].validate(function (valid) {
        if (valid) {
          // debugger;
          var data = _this11.peopleData;
          var user_id = _this11.peopleData.user_id;
          var sid = _this11.dangerIdValue;
          var img_urls = [];
          var uls = document.getElementsByClassName("el-upload-list");
          for (var i = 0; i < uls.length; i++) {
            var imgs = uls[i].getElementsByClassName("imgfileitem");
          ...
          _this11.request({
            ...
            if (data.status == 1) {
              ...
              _this11.diaPeopleFormVisible = false;
              _this11.addPageShow = false;
              _this11.listPageShow = true;
              _this11.goDetail(_this11.dangerIdValue);
            } else {
              _this11.$message({
                showClose: true,
                message: "添加失败",
