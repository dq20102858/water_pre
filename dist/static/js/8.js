...
/* harmony default export */ var conflictcheck = ({
  ...
  methods: {
    ...
    goApply: function goApply(id1, id2, num1, num2, type1, type2) {
...
// load the styles
var content = __webpack_require__("vYBy");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("702098bd", content, true);
