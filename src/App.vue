...
.el-form-custom .el-input__inner{border: 1px #9db9fa solid;color: #4b6eca;}
...
.el-menu-top .el-menu--horizontal > .el-menu-item.is-active {background-color: #4b6eca;color: #fff;border: none;}
</style>