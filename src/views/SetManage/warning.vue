...
<el-row :gutter="20">
  <el-col :xs="8" :sm="8" :md="8" :lg="3" :xl="3" class="grid-menu">
     <h5>设置</h5>
  ...
  <el-col :xs="16" :sm="16" :md="16" :lg="21" :xl="21"><div class="grid-content bg-purple">warning</div></el-col>
</el-row>
...
<style>
.app-set-page{padding: 20px;}
.grid-menu h5{background: #71A7F4;color:#fff;
