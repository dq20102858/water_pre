        ...
        >
          <el-form class="el-form-custom" :model="workData" :rules="wokRules" ref="workForm">
            <el-form-item label="名称：" prop="name">
              <el-input v-model="workData.name" autocomplete="off" placeholder="请输入作业名称" maxlength="20" show-word-limit></el-input>
            </el-form-item>
          ...
          >
            ...
            <el-form :model="historyData" :rules="historyRules" ref="detailForm">
              ...
              <el-form-item label="备注：" prop="remark" label-width="100px" >
                <el-input v-model="historyData.remark" placeholder="填写备注" type="textarea" maxlength="30" show-word-limit></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer">
